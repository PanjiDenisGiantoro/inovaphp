...
function buatKode($tabel, $inisial){
	...
	$panjang1	= mysqli_fetch_field_direct($struktur,0);
    $panjang =is_object($panjang1);
    return is_object($panjang1) ? $panjang1->length : null;
 	...
 	$angka	=strval($angka);
 	$tmp	="";
 	for($i=1; $i<=(4-strlen($inisial)-strlen($angka)); $i++) {
		$tmp=$tmp."0";
	}
